    ...
    <>
      <div className={"box-image-path"} ref={myElementRef}>
        <div className="item-image-path">
          ...
          >
            <div className="template-image-path">
              ...
              <div className="info-path">
                <div className="title-info-path">Shopping Companion</div>
                <div className="description-info-path">
                  Sales chatbot designed to help cu...
                </div>
                <div className="text-botpress-small">Botpress</div>
              </div>
          ...
          <animated.div className="wrapper-image-path second-col-animation" style={{
              transform: scrollY.interpolate(
                (y) =>
                  `translate3d(0px, ${
                    y * 0.075
            ...
            <div className="template-image-path">
              ...
              <div className="info-path">
                <div className="title-info-path">Health Bot</div>
                <div className="description-info-path">
            ...
            <div className="template-image-path">
              ...
              <div className="info-path">
                <div className="title-info-path">Banking Support</div>
                <div className="description-info-path">
          ...
          <animated.div className="wrapper-image-path third-col-animation" style={{
              transform: scrollY.interpolate(
                (y) =>
                  `translate3d(0px, ${
                    y * 0
            ...
            <div className="template-image-path">
              ...
              <div className="info-path">
                <div className="title-info-path">IT Assistant</div>
                <div className="description-info-path">
                  digital assistant that helps IT teams with...
                </div>
                <div className="text-botpress-small">Botpress</div>
              </div>
              <div className="bottom-path">
            ...
            <div className="template-image-path">
              ...
              <div className="info-path">
                <div className="title-info-path">Telco Billing Advisor</div>
                <div className="description-info-path">
              ...
              <div className="bottom-path">
                <div className="download-path">
                  <img
                    ...
                    className="icon-download"
                  />
                  <div className="number-downloads">11.1k</div>
                </div>
                <a
                  href="http://botpress.com/hub?type=Template"
                  target="_blank"
            ...
            <div className="template-image-path">
              ...
              <div className="info-path">
                <div className="title-info-path">Fitness Friend</div>
                <div className="description-info-path">
          ...
          <animated.div className="wrapper-image-path forth-col-animation" style={{
              transform: scrollY.interpolate(
                (y) =>
                  `translate3d(0px, ${
                    y * -0.075
            ...
            <div className="template-image-path">
              ...
              <div className="info-path">
                <div className="title-info-path">Personal Assistant</div>
                <div className="description-info-path">
                  Helps users with their daily tasks, such as...
                </div>
                <div className="text-botpress-small">Botpress</div>
              </div>
              <div className="bottom-path">
          ...
          <animated.div className="wrapper-image-path fifth-col-animation" style={{
              transform: scrollY.interpolate(
                (y) =>
                  `translate3d(0px, ${
                    y * -0.15
            ...
            <div className="template-image-path">
              ...
              <div className="info-path">
                <div className="title-info-path">Language Tutor</div>
                <div className="description-info-path">
