  ...
  return (
    <footer className="footer-main" style={{marginTop:"50px"}}>
        ...
        <div className="wrapper-section">
          <div className="grid-footer">
            <div className="column w-node">
              ...
              />
              <p className="copyright-content mt-3">BotPenguin.</p>
      ...
      <div className="text-bottom-footer">
        <Image width={20} height={20} src="https://assets-global.website-files.com/635c4eeb78332f7971255095/6558efd9ceb72f12e75821b5_check-circle-green.svg" loading="lazy" alt=""/>
        <div className="text-last-footer">
            GDPR&nbsp;Compliant</div>
            <div className="text-last-footer">© Botpress 2024</div></div>
    </footer>
  );
};
